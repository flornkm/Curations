...
export default function Page() {
    ...
    return (
        ...
        <div className="max-w-[90%] mx-auto py-12">
            ...
            <h1 className="text-xl font-semibold mb-8">Legal Notice</h1>
            ...
            <h4 className="text-lg font-medium mt-4 mb-2">Disclaimer</h4>
            ...
            <h4 className="text-lg font-medium mt-4 mb-2">Liability for external links</h4>
            ...
            <h4 className="text-lg font-medium mt-4 mb-2">Copyright</h4>
