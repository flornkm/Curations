    ...
    return (
        ...
        <div className="max-w-[90%] mx-auto py-12 ">
            ...
            <Image
                    ...
                    alt="Curations Logo"
                    className="max-h-7 object-contain object-left mb-16"
                    width={150}
                    height={200}
                />
            </a>
            <h1 className="text-xl font-semibold mb-8">Privacy Policy</h1>
            <p>
            ...
            <p>Anton Stallbörger, Florian Kiem, Nils Eller is authorized to modify this Privacy Policy at any time.
            This may occur without prior notice.</p>
            <p>
            Anton Stallbörger, Florian Kiem, Nils Eller will post the revised Privacy Policy on the https://www.curations.tech/ website</p>

                <h3 className="text-lg font-medium mt-4 mb-2">Collection and Use of Your Personal Information</h3>
                <h4 className="font-medium mt-4 mb-2">Information We Collect</h4>
                <p>
                When using our Service, you will be prompted to provide us with personal information used to
            contact or identify you. https://www.curations.tech/ collects the following information:    </p>
                ...
                <p>
                https://www.curations.tech/ collects and receives information from you in the following manner:    </p>
                <ul>
            ...
            personally may be stored indefinitely.    </p>
                    ...
                    <p>
                    https://www.curations.tech/ may use your information for the following purposes:        </p>
                    <ul>
                                    <li><b>Providing and maintaining our Service,</b> as well as monitoring the usage of our Service.</li>
                                    <li><b>For other purposes.</b> Anton Stallbörger, Florian Kiem, Nils Eller will use your information for data analysis to identify usage
            ...
            your information to evaluate and improve our Service, products, services, and marketing efforts.</li>
                ...
                <h4 className="font-medium mt-4 mb-2">Third-party Sharing</h4>
                ...
                <h4 className="font-medium mt-4 mb-2">Cookies</h4>
                <p>
            ...
            website, eg. language, timezone, enhanced content.</li>
                ...
                <p>
                Your information’s security is important to us. https://www.curations.tech/ 
            ...
            own risk.    </p>
                <p>
                Anton Stallbörger, Florian Kiem, Nils Eller is not responsible for the performance of websites 
            ...
            privacy practices of other websites you interact with and determine the adequacy of those practices.    </p>
                ...
                <h4 className="font-medium mt-4 mb-2">Contact Us</h4>
                <p>For any questions, please contact us through the following methods:</p>
                <p>Name: Anton Stallbörger, Florian Kiem, Nils Eller</p>
                <p>Address: Uferstraße 48, 73525 Schwäbisch Gmünd</p>
                <p>Email: team@curations.tech</p>
                <p>Website: https://www.curations.tech/</p>
                

                        <p>
                    For any queries or concerns you have related to the processing of your information,
            you may contact our Privacy Officer at Anton Stallbörger, Florian Kiem, Nils Eller, team@curations.tech.        </p>
        </div>
        </>
    )
}
